...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig1_reproduction_scatter.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.88\columnwidth]{figures/fig2_hyperparam_heatmap.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig3_variant_bars.pdf}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig4_timing_breakdown.pdf}}
...
\midrule
Week 1 & Paper selection, feasibility check, repository setup \\
Week 2 & Environment setup, dataset download, baseline reproduction run \\
Week 3 & Improvement track design and implementation (Tracks A, B, C) \\
Week 4 & Full-run execution, results analysis, figure generation \\
Week 5 & Report writing, LaTeX assembly, final polishing and submission \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
\midrule
% TODO: Replace with actual names and responsibilities
[Member A] & Reproduction pipeline, environment setup, dataset download,
             baseline runner, notes logging, Track A and C scripts \\
[Member B] & Improvement track design, Track B analysis, full-run execution,
             report draft, LaTeX assembly, figure generation \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
% TODO: Replace with agreed-upon percentages
\begin{itemize}
  \item \textbf{[Member A]:} [XX]\% --- Reproduction infrastructure,
        environment debugging, baseline experiments, Track A/C scripts.
  \item \textbf{[Member B]:} [XX]\% --- Improvement design, Track B analysis,
        full-run hardware, report writing and LaTeX assembly.
\end{itemize}
